# Generated by Django 4.2.3 on 2023-12-06 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquisard', models.BooleanField(default=True, help_text='Avez-vous un maquisard')),
                ('residence_card_number', models.CharField(max_length=20)),
                ('matricule_maquisard', models.CharField(help_text="Si vous n'avez pas de maquisard, ce numéro n'est pas obligatoire. Il est obligatoire si vous en avez.", max_length=20, null=True)),
                ('residence_card_maquisard', models.CharField(help_text='N° de la carte de résidence du Maquisard', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.campus')),
        ...
        migrations.AddField(
            model_name='application',
            name='departement',
            field=models.ForeignKey(help_text="S'il n'y a", null=True, on_delete=django.db.models.deletion.CASCADE, to='app.department'),
        ),
        migrations.AddField(
            model_name='application',
            name='faculty',
        ...
        migrations.AddConstraint(
            model_name='application',
            constraint=models.UniqueConstraint(fields=('matricule', 'student', 'accommodation', 'maquisard', 'residence_card_number', 'date_application'), name='unique_bedroom_application'),
        ),
    ]
